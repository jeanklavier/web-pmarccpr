...
# ============================================================ INFRAESTRUCTURA
{
 ...
 'diagParas':[
   ...
   'Las centrales termoeléctricas se ubicaron cerca de la costa para intercambiar calor con el agua del mar. Hoy el aumento del nivel del mar amenaza sus cimientos. El municipio de Cataño ilustra el escenario: según las proyecciones de la NOAA, para el 2050 será difícil acceder a la central de Palo Seco por la entrada del mar. El Aeropuerto Internacional Luis Muñoz Marín ya registra eventos de inundación prematura, al punto de que expertos plantean la posible mudanza de su actividad aérea al aeropuerto de Aguadilla.',
