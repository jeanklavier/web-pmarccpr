...
# ============================================================ FORESTACION
{
 ...
 'diagParas':[
   'Los bosques de Puerto Rico han sido históricamente subvalorados, relegados frente a la agricultura, la ganadería y el crecimiento urbano. Sin embargo, su servicio más importante es actuar como absorbente de los gases de efecto invernadero — es decir, mitigador del calentamiento global.',
...
# ============================================================ TURISMO
{
 ...
 'heroDesc':'Puerto Rico es un destino de "sol y playa": los turistas gastaron $5,700 millones en 2022 y el sector sostiene 91,500 empleos. Pero el 79% de la infraestructura hotelera es vulnerable al aumento del nivel del mar — el clima que nos hace destino es el mismo que está cambiando.',
 ...
 'diagParas':[
   ...
   'Como destino de sol y playa, el clima es de los criterios más importantes en la selección del destino — y el cambio climático amenaza precisamente eso. El Plan identifica amenazas concretas: olas de calor que afectarán la demanda, eventos extremos que modificarán el paisaje y sus atractivos, más interrupciones por huracanes, contaminación más frecuente de las playas, y un dato mayúsculo: el 79% de la infraestructura hotelera turística es vulnerable al aumento del nivel del mar.',
   'La conclusión del CEACC es directa: una estrategia turística ambiental para atender el cambio climático es fundamental para la subsistencia de Puerto Rico como destino turístico. La adaptación de la infraestructura turística —gris y natural— debe integrarse a la planificación desde ya.',
 ],
...
# ============================================================ EDUCACION
{
 ...
 'heroDesc':'Antes del huracán María, la mayoría de la población no tenía una percepción clara de lo que el cambio climático implicaba para Puerto Rico. El Plan lo dice sin rodeos: el desconocimiento sobre el cambio climático debe considerarse un asunto de emergencia.',
...
# ============================================================ JUSTICIA
{
 ...
 'heroDesc':'Puerto Rico figura entre los territorios más afectados del mundo por eventos climáticos extremos entre 2000 y 2019 — con una población donde el 44.5% vive bajo el nivel de pobreza. La justicia climática pregunta: ¿quién sufre primero, quién decide y quién recibe los fondos?',
